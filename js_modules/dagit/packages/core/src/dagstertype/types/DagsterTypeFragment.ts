...
export interface DagsterTypeFragment_metadataEntries_LogicalVersionMetadataEntry {
...
export interface DagsterTypeFragment_innerTypes_metadataEntries_LogicalVersionMetadataEntry {
  __typename: "LogicalVersionMetadataEntry";
  label: string;
  description: string | null;
}
