...
export interface AssetEventsQuery_assetOrError_Asset_assetObservations_metadataEntries_LogicalVersionMetadataEntry {
...
export interface AssetEventsQuery_assetOrError_Asset_assetMaterializations_metadataEntries_LogicalVersionMetadataEntry {
  __typename: "LogicalVersionMetadataEntry";
  label: string;
  description: string | null;
  value: string;
