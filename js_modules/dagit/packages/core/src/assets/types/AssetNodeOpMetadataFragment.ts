...
export interface AssetNodeOpMetadataFragment_metadataEntries_LogicalVersionMetadataEntry {
...
export interface AssetNodeOpMetadataFragment_type_innerTypes_metadataEntries_LogicalVersionMetadataEntry {
  __typename: "LogicalVersionMetadataEntry";
  label: string;
  description: string | null;
}
